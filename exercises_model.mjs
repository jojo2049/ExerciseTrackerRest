...
/**
 * Retrive exercises with projection and limit 
...
/**
 * Update the exercise by the ID provided with new information
 * @param {String} _id 
 * @param {String} name 
 * @param {Number} reps
 * @param {Number} weight  
...
export { createExercise, findExercises, deleteById, replaceExercise };